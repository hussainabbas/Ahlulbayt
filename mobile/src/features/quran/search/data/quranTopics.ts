...
export interface QuranTopicEntry {
  ...
  /** Synonyms and related phrases across languages for semantic matching. */
  synonyms: string[];
  ayahRefs: AyahRef[];
  /** Short explanation shown in AI search results. */
  summary: { en: string; ur: string };
}

/** Curated Shia-aware topic → ayah mapping for offline semantic retrieval. */
export const QURAN_TOPIC_INDEX: QuranTopicEntry[] = [
  ...
  },
  {
    ...
    synonyms: ['marriage', 'nikah', 'spouse', 'wife', 'husband', 'family', 'ازدواج', 'شadi', 'mawaddah'],
...
export const SEARCH_EXAMPLE_QUERIES = [
  ...
  'Find verses about Imam Ali',
  'Find verses about charity',
  'Verses about Ahlul Bayt',
